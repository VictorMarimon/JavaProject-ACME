package ACME.MODELO.DAO.ESTADO;
...
public class EstadoDAO implements IDAO {
    ...
    public boolean buscar(Object object) {
        ...
        var sql = "SELECT * FROM ESTADO WHERE ESTADO = ?";
        ...
        try{
            ...
            System.out.println("Error al buscar estado acceso por estado " + e.getMessage());
        }finally {
            try{
                con.close();
    ...
    public int buscarID(Object object){
        ...
        var sql = "SELECT ID FROM ESTADO WHERE ESTADO = ?";
        ...
        try{
            ...
            System.out.println("Error al buscar id estado acceso por estado " + e.getMessage());
        }finally {
            try{
                con.close();
            } catch (SQLException e) {
