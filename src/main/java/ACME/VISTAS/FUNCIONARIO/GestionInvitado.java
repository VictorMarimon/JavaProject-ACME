...
public class GestionInvitado extends JFrame {
    private JTextField txtIdentificacion, txtPrimerNombre, txtSegundoNombre, txtPrimerApellido, txtSegundoApellido,
            txtCorreo, txtTelefono, txtNIT, txtCalle, txtCarrera, txtTransversal,
    ...
    public GestionInvitado() {
        ...
        JLabel lblTitulo = new JLabel("INVITADO");
        ...
        btnAgregar.addActionListener(e -> {
            ...
            cargo.setNombre_cargo("Invitado");

                    if (cd.agregarDireccion(d, c) && cp.nuevaPersona(per, t, ep, d) && ce.nuevoEmpleado(per, emp, cargo)){

                        JOptionPane.showMessageDialog(this, "Invitado agregado con éxito.");
                        ...
                        JOptionPane.showMessageDialog(this, "Falta llenar campos o el invitado ya existe.");
                    }
        });
    ...
    public static void main(String[] args) {
        GestionInvitado gf = new GestionInvitado();
