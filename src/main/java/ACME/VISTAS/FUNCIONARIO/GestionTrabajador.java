...
public class GestionTrabajador extends JFrame {
    ...
    public GestionTrabajador() {
        ...
        JLabel lblTitulo = new JLabel("TRABAJADOR");
        ...
        btnAgregar.addActionListener(e -> {
            ...
            cargo.setNombre_cargo("Operario de Producción");
                    ...
                    if (cd.agregarDireccion(d, c) && cp.nuevaPersona(per, t, ep, d) && ce.nuevoEmpleado(per, emp, cargo)){
                        ...
                        JOptionPane.showMessageDialog(this, "Falta llenar campos o el trabajador ya existe.");
                    }
        });
    ...
    public static void main(String[] args) {
        GestionTrabajador gf = new GestionTrabajador();
