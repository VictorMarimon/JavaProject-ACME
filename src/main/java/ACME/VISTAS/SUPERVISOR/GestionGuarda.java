...
public class GestionGuarda extends JFrame {
    ...
    public GestionGuarda() {
        ...
        JLabel lblTitulo = new JLabel("GUARDIA");
        ...
        btnAgregar.addActionListener(e -> {
            ...
            try {
                if (gestor.verificarCredencial(txtUsuario.getText(), txtContrasena.getText())){
                    ...
                    if (cd.agregarDireccion(d, c) && cp.nuevaPersona(per, t, ep, d)){
                        ...
                        JOptionPane.showMessageDialog(this, "Guardia agregado con éxito.");
                        ...
                        JOptionPane.showMessageDialog(this, "Falta llenar campos o el guardia ya existe.");
                    }
                }
    ...
    public static void main(String[] args) {
        GestionGuarda gf = new GestionGuarda();
