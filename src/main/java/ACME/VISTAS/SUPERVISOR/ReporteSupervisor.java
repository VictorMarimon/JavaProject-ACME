...
public class ReporteSupervisor extends JFrame {
    ...
    public ReporteSupervisor() {
        ...
        btnCancelar.addActionListener(e -> {
            MenuSupervisor menuPrincipal = new MenuSupervisor();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ReporteSupervisor().setVisible(true));
    }
}
