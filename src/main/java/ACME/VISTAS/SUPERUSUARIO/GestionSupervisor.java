...
public class GestionSupervisor extends JFrame {
    ...
    public GestionSupervisor() {
        ...
        JLabel lblTitulo = new JLabel("SUPERVISOR");
        ...
        btnAgregar.addActionListener(e -> {
            ...
            cargo.setNombre_cargo("Supervisor de Operaciones");
            ...
            try {
                if (gestor.verificarCredencial(txtUsuario.getText(), txtContrasena.getText())){
                    ...
                    if (cd.agregarDireccion(d, c) && cp.nuevaPersona(per, t, ep, d) && ce.nuevoEmpleado(per, emp, cargo)){
                        ...
                        try {
                            Supervisor supervisor = new Supervisor(txtUsuario.getText(), txtContrasena.getText());
                            gestor.guardarCredencial(supervisor);
                        } catch (CredencialesException ee) {
                            System.err.println("Error: " + ee.getMessage());
                        }

                        JOptionPane.showMessageDialog(this, "Supervisor agregado con éxito.");
                        ...
                        JOptionPane.showMessageDialog(this, "Falta llenar campos o el supervisor ya existe.");
                    }
                }
    ...
    public static void main(String[] args) {
        GestionSupervisor gf = new GestionSupervisor();
